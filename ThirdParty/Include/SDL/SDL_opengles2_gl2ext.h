...
GL_APICALL void GL_APIENTRY glGetProgramPipelineInfoLog::ErrorXT (GLuint pipeline, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
#endif
...
typedef void (GL_APIENTRYP PFNGLGETPROGRAMPIPELINEINFOLog::ErrorXTPROC) (GLuint pipeline, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
#endif
